...
void CollisionTestScene::Update()
{
	...
	static float fAngle = 0;
	{
		...
		SVector2 vScale(1, 1);
		cTrnasform.SetTranslate(vPlayerPos);
	...
	static SVector2 vOpossumPos(100, 100);
	{
		...
		SVector2 vScale(1, 1);
		cTrnasform.SetTranslate(vOpossumPos);
		SVector2 vAsix = vSize * 0.5f;
		cTrnasform.SetAsixPoint(vAsix);
	...
	static SVector2 vEaglePos(300, 300);
	{
		...
		SVector2 vScale(1, 1);
		cTrnasform.SetTranslate(vEaglePos);
		SVector2 vAsix = vSize * 0.5f;
		cTrnasform.SetAsixPoint(vAsix);
...
void CollisionTestScene::CollisionCheckDraw()
{
	...
	SVector2 vPlayerPos = m_pPlayerObject->GetTransform().GetTranslate();
	...
	SVector2 vEaglePos = m_pEagleObject->GetTransform().GetTranslate() + vEagleSize * 0.5f;
...
void CollisionTestScene::ColliderDraw()
{
	...
	if (m_pPlayerBoxCollider->ToRect(m_pOpossumRectCollider)) {
		...
		CDebugHelper::LogConsole("Collide");
	}
	else {
