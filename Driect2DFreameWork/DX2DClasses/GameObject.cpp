...
void CTransform::SetTranslate(const SVector2& pos)
{
	matTransform = D2D1::Matrix3x2F::Translation(pos.x, pos.y);
}
void CTransform::SetTranslate(float x, float y)
{
...
void CTransform::Translate(const SVector2& pos)
{
	D2D1::Matrix3x2F matT = D2D1::Matrix3x2F::Translation(pos.x, pos.y);
...
SVector2 CTransform::GetTranslate()
{
...
CAnimator2D* CGameObject::GetAnimator() {
	return m_pAnimator;
}
